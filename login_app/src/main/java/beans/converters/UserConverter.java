...
public class UserConverter {
    ...
    public Optional<User> toEntity(UserDTO dto) {
        ...
        return Optional.of(new User(dto.getId(), dto.getEmail(), dto.getName(),
    ...
    public Optional<UserDTO> toDTO(User entity) {
        if (entity == null)
            return Optional.empty();
        return Optional.of(new UserDTO(entity.getId(), entity.getLogin(), entity.getName(), entity.getPassword(),
